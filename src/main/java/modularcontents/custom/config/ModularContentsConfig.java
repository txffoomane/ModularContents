...
public class ModularContentsConfig {
    ...
    public static int airdropCallerCooldown = 1200;
    ...
    public static void syncConfig() {
        ...
        airdropCallerCooldown = config.getInt("Cooldown (Ticks)", callerCat, 1200, 0, 72000, "Cooldown in ticks (20 ticks = 1 second) after using an airdrop caller item");
